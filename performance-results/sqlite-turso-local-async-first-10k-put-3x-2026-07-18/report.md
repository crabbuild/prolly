...
Schema: `sqlite-turso-local-v1`. Revision: `async-first-coalesced` (dirty: `true`). Planned repetitions: 3.
...
|---:|---|---|---:|---:|
| 10,000 | put | append | 5.561× | 0.180× |
| 10,000 | put | clustered | 8.171× | 0.122× |
| 10,000 | put | random | 4.610× | 0.217× |

## Fixture build context

| Adapter | Records | Median build ms | Median records/s | Median bytes |
|---|---:|---:|---:|---:|
| sqlite-sync | 10,000 | 5.237 | 1909474.9 | 483328 |
| turso-async | 10,000 | 10.606 | 942903.2 | 515008 |

## Largest observed differences

- Largest latency-ratio departure from parity: 10,000 records, put/clustered at 8.171× Turso/SQLite.
- Largest throughput-ratio departure from parity: 10,000 records, put/clustered at 0.122× Turso/SQLite.
