...
Schema: `sqlite-turso-local-v1`. Revision: `unified-writes` (dirty: `true`). Planned repetitions: 3.
...
|---:|---|---|---:|---:|
| 10,000 | put | append | 2.429× | 0.412× |
| 10,000 | put | clustered | 2.616× | 0.382× |
| 10,000 | put | random | 2.125× | 0.471× |

## Fixture build context

| Adapter | Records | Median build ms | Median records/s | Median bytes |
|---|---:|---:|---:|---:|
| sqlite-sync | 10,000 | 5.680 | 1760434.1 | 483328 |
| turso-async | 10,000 | 9.712 | 1029605.5 | 515008 |

## Largest observed differences

- Largest latency-ratio departure from parity: 10,000 records, put/clustered at 2.616× Turso/SQLite.
- Largest throughput-ratio departure from parity: 10,000 records, put/clustered at 0.382× Turso/SQLite.
