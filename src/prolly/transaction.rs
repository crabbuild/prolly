...
impl TransactionalStore for super::store::MemStore {}
impl TransactionalStore for super::store::FileNodeStore {}

#[cfg(feature = "rocksdb")]
impl TransactionalStore for super::store::RocksDBStore {}

#[cfg(feature = "pglite")]
impl TransactionalStore for super::store::PgliteStore {}

#[cfg(feature = "slatedb")]
impl TransactionalStore for super::store::SlateDbStore {}
