...
pub struct SecondaryIndexLimits {
    ...
    pub max_derived_mutations_per_write: usize,
    pub max_projected_bytes_per_write: usize,
...
impl Default for SecondaryIndexLimits {
    fn default() -> Self {
        Self {
            ...
            max_derived_mutations_per_write: 100_000,
            max_projected_bytes_per_write: 64 * 1024 * 1024,
            max_indexes: 32,
    ...
    fn validate(&self) -> Result<(), Error> {
        let values = [
            ...
            (
                ...
                self.max_derived_mutations_per_write,
            ),
            (
