...
```rust,ignore
pub enum RepositoryStorageProfileV2 {
    DirectContentAddressedV1,
    NativeVersionedV1 {
        node_store: PackedNodeStoreV1,
        writer_topology: ExclusiveWriterV1,
    },
}
```
...
It is simple and distributed, but a single logical mutation rewrites several
