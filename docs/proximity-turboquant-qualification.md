...
| Sync/async, catalog, composite, proof, content graph, and GC integration | focused proximity accelerator, async, proof, and content-graph tests, including explicit TurboQuant cancellation/deadline completions and typed rejection of old proof versions before closure work | Implemented |
