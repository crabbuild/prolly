...
pub const SCHEMA_VERSION: &str = "redis-scale-v1";
...
pub struct RawRow {
    ...
    pub redis_used_memory_bytes: u64,
    pub redis_used_memory_rss_bytes: u64,
    pub redis_used_memory_dataset_bytes: u64,
    pub aof_current_size_bytes: u64,
    pub namespace_keys: usize,
