...
use prolly_redis_scale_bench::cli::parse_args;
use prolly_redis_scale_bench::model::{
...
fn full_profile_freezes_the_one_million_baseline() {
    ...
    assert_eq!(
        ...
        "performance-results/redis/baseline"
    );
...
fn smoke_profile_and_filters_are_explicit() {
    ...
    assert_eq!(config.redis_url, "redis://127.0.0.1:56379/");
