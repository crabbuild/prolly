...
pub use domain::proximity::{
    ...
    default_proximity_config, exact_proximity_search_request, verify_proximity_membership_proof,
    verify_proximity_structure_proof, AdaptiveQualityRecord, BindingHnswIndex, BindingProximityMap,
    BindingProximityReadSession, BindingProximitySearchProof, ContentGraphLimitsRecord,
    ContentObjectKindRecord, DistanceMetricRecord, ExactProximityRecordRecord,
    HnswBuildLimitsRecord, HnswBuildResultRecord, HnswBuildStatsRecord, HnswConfigRecord,
    HnswRoutingVectorEncodingRecord, ProximityConfigRecord, ProximityFilterKind,
