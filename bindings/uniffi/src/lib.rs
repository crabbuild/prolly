...
pub use domain::proximity::{
    ...
    default_pq_build_limits, default_pq_config, default_proximity_config,
    exact_proximity_search_request, verify_proximity_membership_proof,
    verify_proximity_structure_proof, AdaptiveQualityRecord, BindingHnswIndex,
    BindingProductQuantizer, BindingProximityMap, BindingProximityReadSession,
    BindingProximitySearchProof, ContentGraphLimitsRecord, ContentObjectKindRecord,
    DistanceMetricRecord, ExactProximityRecordRecord, HnswBuildLimitsRecord, HnswBuildResultRecord,
    HnswBuildStatsRecord, HnswConfigRecord, HnswRoutingVectorEncodingRecord,
    ProductQuantizationBuildLimitsRecord, ProductQuantizationBuildResultRecord,
    ProductQuantizationBuildStatsRecord, ProductQuantizationConfigRecord,
    ProductQuantizationQualityRecord, ProximityConfigRecord, ProximityFilterKind,
    ProximityFilterRecord, ProximityMembershipProofRecord, ProximityMembershipVerificationRecord,
    ProximityMutationRecord, ProximityMutationResultRecord, ProximityMutationStatsRecord,
    ProximityNeighborRecord, ProximityRecordRecord, ProximityRecordVisitorCallback,
    ProximitySearchClaimKindRecord, ProximitySearchClaimRecord, ProximitySearchRequestRecord,
    ProximitySearchResultRecord, ProximitySearchStatsRecord, ProximitySearchVerificationRecord,
    ProximityStructuralProofRecord, ProximityStructuralVerificationRecord,
    ProximityVerificationRecord, QueryKernelRecord, SearchBackendRecord, SearchBudgetRecord,
    SearchCompletionRecord, SearchPolicyKind, TypedContentObjectRecord,
};
