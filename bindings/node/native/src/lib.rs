...
use prolly_bindings::{
    ...
    inspect_proof_bundle, is_tombstone_value, key_from_prefixed_segments, key_from_segments,
    key_proof_from_bytes, key_proof_from_node_bytes, key_proof_path_node_bytes, key_proof_to_bytes,
    large_value_config, multi_key_proof_from_bytes, multi_key_proof_from_node_bytes,
    multi_key_proof_path_node_bytes, multi_key_proof_to_bytes, multi_value_set_from_bytes,
    multi_value_set_merge, multi_value_set_to_bytes, node_cid, node_from_bytes, node_to_bytes,
    parallel_config, parallel_config_sequential, prefix_end, prefix_range, range_cursor_after_key,
    range_cursor_start, range_page_proof_from_bytes, range_page_proof_from_node_bytes,
    range_page_proof_path_node_bytes, range_page_proof_to_bytes, range_proof_from_bytes,
    range_proof_from_node_bytes, range_proof_path_node_bytes, range_proof_to_bytes,
    resolution_delete, resolution_unresolved, resolution_value, resolve_delete_wins,
    resolve_prefer_left, resolve_prefer_right, resolve_update_wins, retain_all_named_roots,
    retain_exact_named_roots, retain_named_root_prefix, retain_named_roots_updated_since,
    retain_newest_named_roots, reverse_cursor_before_key, reverse_cursor_end,
    root_manifest_from_bytes, root_manifest_to_bytes, sign_proof_bundle_hmac_sha256,
    snapshot_bundle_digest, snapshot_bundle_digest_bytes, snapshot_bundle_from_bytes,
    snapshot_bundle_summary, snapshot_bundle_summary_from_bytes, snapshot_bundle_to_bytes,
    snapshot_id_from_name, snapshot_namespace_branch, snapshot_namespace_checkpoint,
    snapshot_namespace_custom, snapshot_namespace_tag, snapshot_root_name, timestamp_millis_key,
    timestamped_value_from_bytes, timestamped_value_now, timestamped_value_to_bytes,
    tombstone_compaction_mutation, tombstone_from_bytes, tombstone_from_stored_bytes,
    tombstone_to_bytes, tombstone_upsert_mutation, tree_config, u128_key, u64_key, upsert_mutation,
    value_ref_from_bytes, value_ref_from_stored_bytes, value_ref_inline_requires_escape,
    value_ref_to_bytes, verify_authenticated_proof_bundle, verify_authenticated_proof_envelope,
    verify_diff_page_proof, verify_key_proof, verify_multi_key_proof, verify_proof_bundle,
    verify_range_page_proof, verify_range_proof, verify_snapshot_bundle,
    verify_snapshot_bundle_bytes, versioned_value_bytes_matches_schema,
...
impl BindingHostStoreCallback for NodeHostStore {
    ...
    fn publish_nodes(
        ...
        let request = NodeHostStorePublicationRequest {
            ...
            hint: publication
                .hint
                .map(|hint| NodeHostStorePublicationHintRecord {
