...
data class JavaBatchApplyStats(
    ...
    val entriesStreamed: Long,
    val nodesRead: Long,
    val writtenNodes: Long,
    val nodesReused: Long,
    val bytesRead: Long,
    val writtenBytes: Long,
    val resyncDistanceEntries: Long,
    val resyncDistanceNodes: Long,
    val usedKeyStableFastPath: Boolean,
    val usedBatchedValueUpdatePath: Boolean,
...
private fun BatchApplyStatsRecord.toJava() = JavaBatchApplyStats(
    ...
    entriesStreamed.toLong(), nodesRead.toLong(), writtenNodes.toLong(), nodesReused.toLong(),
    bytesRead.toLong(), writtenBytes.toLong(), resyncDistanceEntries.toLong(),
    resyncDistanceNodes.toLong(), usedKeyStableFastPath, usedBatchedValueUpdatePath,
